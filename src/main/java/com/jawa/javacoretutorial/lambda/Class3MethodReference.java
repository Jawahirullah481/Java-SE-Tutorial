package com.jawa.javacoretutorial.lambda;
...
public class Class3MethodReference extends LambdaHandler {
    ...
    /*
        ...
        Method Reference Always used instead of single statement com.jawa.javacoretutorial.lambda expression. Without this only scenario, we can't use method reference.


        2. Is there any rules ?

        By writing com.jawa.javacoretutorial.lambda expression, what we are actually doing is,

        # we are creating the anonymous class of the functional interface and providing implementation of that method.
        # By using method reference in place of com.jawa.javacoretutorial.lambda expression, what will happen is, inside that implementation of that anonymous class' function, our method reference call will happen.
