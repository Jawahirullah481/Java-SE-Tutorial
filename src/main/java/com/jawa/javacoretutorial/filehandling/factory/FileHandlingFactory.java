package com.jawa.javacoretutorial.filehandling.factory;

import com.jawa.javacoretutorial.filehandling.handler.FileHandler;
import com.jawa.javacoretutorial.filehandling.io.*;
import com.jawa.javacoretutorial.filehandling.nio.*;

public class FileHandlingFactory {

    public static void execute() {

        String concept = "AppendIntoFile";
